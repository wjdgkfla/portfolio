  ...
  return (
    <section id="contact">
      <div className="container">
        ...
        <p className="section-lede">I am open to internships in analytics, data, AI, operations, and business technology, as well as full-time opportunities — I graduate in June 2027. The fastest way to reach me is email.</p>
